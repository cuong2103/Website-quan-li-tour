...
<aside class="w-64 bg-white shadow-lg h-screen fixed inset-y-0 left-0 flex flex-col z-50">
  ...
  <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
    ...
    <!-- Khách hàng -->
<<<<<<< HEAD
    <a href="<?php echo BASE_URL . '?act=customers'; ?>" class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg transition">
...
>>>>>>> dc718730c3239e5f02df97af76c4307e9b2108ff
      Khách hàng
    </a>
